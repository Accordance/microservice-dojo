...
Here we're going to add a new field *full_name* to the *account* table so our
users can add their full name to their accounts.

NOTE: The solution to this exercise part can be found in *solution2* folder.

Add a second migration (to V2):
[source,text,indent=0]
.src/main/resources/db/migration/V2__add_full_name.sql
----
include::{sourcedir}/solution2/accounts-service/src/main/resources/db/migration/V2__add_full_name.sql[]
----

Add the *fullName* mapping to the data model:
[source,java,indent=0]
.src/main/java/msvcdojo/AccountsServiceApplication.java
----
...
.src/main/java/msvcdojo/AccountsServiceApplication.java
----
include::{sourcedir}/solution2/accounts-service/src/main/java/msvcdojo/AccountsServiceApplication.java[tags=findByFullName]
----
...
....
$ curl http://localhost:8100/accounts/search/findByFullName?fullName=John%20Doe
....
...
....
{
  ...
  "_links" : {
    "self" : {
      "href" : "http://localhost:8100/accounts/search/findByFullName?fullName=John%20Doe"
    }
  }
}
....
