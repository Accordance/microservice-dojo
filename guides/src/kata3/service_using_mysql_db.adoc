...
NOTE: In real life you may want to manage DB migrations separately from the
...
more records to the database - you have to escape the double quotes in the echo command:
