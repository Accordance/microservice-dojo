...
But on Windows we have to use the IP of docker-machine, which we find as follows:
----
...
If you edit the hosts file - as Administrator - typically, at C:\Windows\System32\drivers\etc and add the line:
----
192.168.99.100	dockerhost
----

Then you can use 'dockerhost':
----
