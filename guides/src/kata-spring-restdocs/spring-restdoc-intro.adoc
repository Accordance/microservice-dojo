...
image::rest-maturity-model.png[richardsonMaturityModel, link="http://martinfowler.com/articles/images/richardsonMaturityModel/overview.png"]
...
. Guarantees that API documentation and implementation code are always in-sync. Forces you to update documentation for any implementation changes.
